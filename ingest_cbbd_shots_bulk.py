...
Examples:
    python ingest_cbbd_shots_bulk.py --first 2020 --last 2026
    python ingest_cbbd_shots_bulk.py --first 2026 --last 2026 --refresh
    python ingest_cbbd_shots_bulk.py --export shot_exports/shots.jsonl.gz
"""
...
from ingest_cbbd_shots import export_events, infer_export_format, model_payload
...
def main() -> None:
    ...
    try:
        commit = pipeline_commit(Path(__file__).resolve().parent)
