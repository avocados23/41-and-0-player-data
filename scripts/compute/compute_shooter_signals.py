...
Run independently after ingestion when scoring weights or thresholds change:
    python -m scripts.compute.compute_shooter_signals --first 2020 --last 2026
"""
...
from bracketballer_data.shooting_data import ShootingAggregate, build_shooting_profiles
