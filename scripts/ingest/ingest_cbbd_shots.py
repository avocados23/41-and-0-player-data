...
Examples:
    python -m scripts.ingest.ingest_cbbd_shots
    python -m scripts.ingest.ingest_cbbd_shots --player-id 2246 --refresh
    python -m scripts.ingest.ingest_cbbd_shots --first 2020 --last 2026 \
        --export data/exports/shots/shots_2020_2026.jsonl.gz
...
from bracketballer_data.shooting_data import EVENT_DB_COLUMNS, event_record, normalize_play
