...
Reads every data/raw/player_seasons/<season>/players.csv, concatenates them, computes
per-game derived stats, and selects each athlete's best season.

Run from the project root:
    python -m scripts.publish.process_players
"""
...
from bracketballer_data.paths import PROCESSED_CORE, RAW_PLAYER_SEASONS

SEASONS_DIR = RAW_PLAYER_SEASONS
OUTPUT_FILE = PROCESSED_CORE / "processed_players.csv"
POSITIONS_FILE = PROCESSED_CORE / "player_positions.csv"
...
def main() -> None:
    PROCESSED_CORE.mkdir(parents=True, exist_ok=True)
